...
// ---- media upload ----
// Uses multipart/form-data straight to the media-upload Edge Function, which
// streams the file to storage instead of buffering it as base64 — regular
// Netlify Functions cap request bodies around 6MB, which is what broke video
// uploads before. Works for files up to 100MB (images or video).
export async function uploadMedia(file, onProgress) {
  ...
  return res.json(); // { ok, key, url, mediaType }
}
