...
export default function AdminArticles() {
  ...
  async function editArticle(a) {
    try {
      ...
      // getArticles with slug returns a single object already (see api.js) but
      // we call the raw endpoint here for the full record incl. media:
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      else { const r = await createArticle(form); notify('Article created'); }
      resetForm();
      refresh();
    } catch (err) {
      notify(err.message, 'error');
            ...
            <div className="slide-row" key={a.id}>
              <div className="thumb">
                {a.cover_media_type === 'video'
                  ...
                  : <img src={a.cover_media_url} alt={a.title} />}
              </div>
              <div className="meta">
