          ...
          <div style={{ display: 'flex', gap: 64, flexWrap: 'wrap' }}>
            <div>
              ...
              <ul style={{ display: 'flex', flexDirection: 'column', gap: 9 }}>
                <li><a href="/" style={{ fontSize: 14, color: 'var(--text-dim)' }}>Home</a></li>
                <li><a href="/about" style={{ fontSize: 14, color: 'var(--text-dim)' }}>About MySignal</a></li>
                <li><a href="/gallery" style={{ fontSize: 14, color: 'var(--text-dim)' }}>Gallery</a></li>
                <li><a href="/news" style={{ fontSize: 14, color: 'var(--text-dim)' }}>News</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul style={{ display: 'flex', flexDirection: 'column', gap: 9 }}>
                ...
                <li><a href="/contact" style={{ fontSize: 14, color: 'var(--text-dim)' }}>Get in touch</a></li>
              </ul>
            </div>
          </div>
        </div>
