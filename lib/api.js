...
// ---- site pages (About, Contact — admin-editable via block editor) ----
export const getSitePage = (slug) => req(`/site-pages?slug=${encodeURIComponent(slug)}`);
export const updateSitePage = (data) => req('/site-pages', { method: 'PUT', body: JSON.stringify(data) });
